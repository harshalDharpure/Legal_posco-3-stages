...
Example:
  python q1_3stage_pipeline/stage2/train.py \
    ...
    --output-dir q1_3stage_pipeline/outputs/checkpoints/stage2/M2_base_full_seed42 \
    --seed 42
"""
...
from q1_3stage_pipeline.stage1.dataset import LegalSFTDataset, collate_sft_batch
from q1_3stage_pipeline.stage2.hard_negatives import (
    corrupt_legal_text,
    cross_sample_negative,
    model_negative_generate,
    select_hard_negative,
)
from q1_3stage_pipeline.stage2.losses import (
